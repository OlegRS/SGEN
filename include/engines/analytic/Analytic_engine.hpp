...
public:
  ...
  Analytic_engine(Neuron& neuron, bool cov_mat_init=false) :
    p_neuron(&neuron),
    o1_dim(3 + 2*neuron.p_dend_segments.size() + neuron.p_spines.size()),
    ...
    o1_prot_matrix(1+neuron.p_dend_segments.size()+neuron.p_spines.size(), 1+neuron.p_dend_segments.size()+neuron.p_spines.size()),
    ...
    o1_prot_RHS(1+neuron.p_dend_segments.size()+neuron.p_spines.size()),
    protein_expectations(1+neuron.p_dend_segments.size()+neuron.p_spines.size()),
    o1_prot_names(1+neuron.p_dend_segments.size()+neuron.p_spines.size()),
    ...
    p_o1_prot_expectations(1+neuron.p_dend_segments.size()+neuron.p_spines.size()),
