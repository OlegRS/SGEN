...
public:
  Soma(const std::string& name="no_name", const double& length=20, const double& x=0, const double& y=0, const double& z=0, const double& r=10, const size_t& n_gene_copies=1, const double& gene_activation_rate=1/12., const double& gene_deactivation_rate=1/12., const double& mRNA_decay_rate=0.0432, const double& translation_rate=75.6, const double& protein_decay_rate=0.004356, const double& mRNA_diffusion_constant=3.4e-3, const double& protein_diffusion_constant=.24, const double& mRNA_forward_trafficking_velocity=.5e-2, const double& mRNA_backward_trafficking_velocity=.1e-2, const double& protein_forward_trafficking_velocity=0, const double& protein_backward_trafficking_velocity=0) : Compartment(length, name, x, y, z, r, theta,phi,mRNA_decay_rate,translation_rate,protein_decay_rate,mRNA_diffusion_constant,protein_diffusion_constant,mRNA_forward_trafficking_velocity,mRNA_backward_trafficking_velocity,protein_forward_trafficking_velocity,protein_backward_trafficking_velocity), gene_activation(this), gene_deactivation(this), number_of_gene_copies(n_gene_copies), gene_activation_rate(gene_activation_rate), gene_deactivation_rate(gene_deactivation_rate) {}
