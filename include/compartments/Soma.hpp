...
public:
  Soma(const std::string& name="no_name", const double& length=20, const double& x=0, const double& y=0, const double& z=0, const double& r=10, const size_t& n_gene_copies=1, const double& gene_activation_rate=1/12., const double& gene_deactivation_rate=1/12., const double& mRNA_decay_rate=0.0432, const double& transcription_rate=.216, const double& translation_rate=75.6, const double& protein_decay_rate=0.004356, const double& mRNA_diffusion_constant=3.4e-3*3600, const double& protein_diffusion_constant=.24*3600, const double& mRNA_forward_trafficking_velocity=.5e-2*3600, const double& mRNA_backward_trafficking_velocity=.1e-2*3600, const double& protein_forward_trafficking_velocity=0, const double& protein_backward_trafficking_velocity=0) :
